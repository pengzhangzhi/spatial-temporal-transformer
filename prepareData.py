...
def generate_data(config_name):
    ...
    if dataset == "TaxiBJ":
        ...
        X_train, Y_train, X_test, Y_test, mmn, external_dim, timestamp_train, timestamp_test = \
            load_data_BJ(T=T, nb_flow=nb_flow, len_closeness=len_closeness, len_period=len_period,
                         len_trend=len_trend,
        ...
        X_train, Y_train, X_test, Y_test, mmn, external_dim, timestamp_train, timestamp_test = \
            load_data_NY(original_filename, T=T, nb_flow=nb_flow, len_closeness=len_closeness,
...
if __name__ == '__main__':
    ...
    argparser.add_argument('-c', "--config-name", type=str, default="TaxiBJ_c4_t1_depth6_pre_train_epoch1200_random_pick")
